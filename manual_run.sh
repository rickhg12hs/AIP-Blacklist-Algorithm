		...
		do
		  ...
		  then
		  	mkdir $output_folder
				...
				mkdir $output_folder/Historical_Ratings/Random_Forest_Aggregate/
				mkdir $output_folder/Historical_Ratings/Random_Forest_Concatinate/
				mkdir $output_folder/ML_Model_Data/
				touch $output_folder/ML_Model_Data/temp_aggregate_data_labeled.csv
				touch $output_folder/ML_Model_Data/temp_aggregate_data.csv
				touch $output_folder/ML_Model_Data/concatinated_data_labeled.csv
				touch $output_folder/ML_Model_Data/new_data_labeled.csv
        ...
        touch $output_folder/Aging-modifiers-pn.csv
		  ...
		  then
		  	...
		  	read output_folder
				...
				touch $output_folder/ML_Model_Data/temp_aggregate_data.csv
				touch $output_folder/ML_Model_Data/concatinated_data_labeled.csv
				touch $output_folder/ML_Model_Data/new_data.csv
				touch $output_folder/ML_Model_Data/previous_unlabeled_data.csv
				touch $output_folder/Absolute_Data.csv
				touch $output_folder/FP_log_file.csv
				touch $output_folder/log.txt
				touch $output_folder/Known_IPs.txt
...
# echo $directory_of_AIP/Main/select_linear_models.py
...
do
   ...
   cp $output_folder/Absolute_Data.csv $output_folder/ML_Model_Data/temp_aggregate_data.csv
...
#   and used to label the previous unlabeled day data for the concatination model.
   cp $entry $output_folder/ML_Model_Data/new_data.csv
...
#   concatinated_data_labeled file.
   sh $directory_of_AIP/Main/ML-Model/label_data.sh
#   run AIP. This will:
...
#   Save the new_data.csv file to previous_unlabeled_data.csv, so that it can be used in the next run
   cp $output_folder/ML_Model_Data/new_data.csv $output_folder/ML_Model_Data/previous_unlabeled_data.csv
